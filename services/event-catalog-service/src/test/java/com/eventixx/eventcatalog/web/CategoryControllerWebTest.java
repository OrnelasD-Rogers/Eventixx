...
class CategoryControllerWebTest {
    ...
    void shouldGetCategoryById() throws Exception {
        CategoryResponse response = new CategoryResponse(categoryId, "Music", "Desc", Instant.now(), Instant.now());
    ...
    void shouldListCategories() throws Exception {
        Page<CategorySummaryResponse> page = new PageImpl<>(List.of(
            new CategorySummaryResponse(categoryId, "Music")
        ));
