...
class EventControllerWebTest {
  ...
  void shouldCreateEvent() throws Exception {
    CreateEventRequest request =
        new CreateEventRequest(
            ...
            List.of(
                new com.eventixx.eventcatalog.dto.tickettype.CreateTicketTypeRequest(
  ...
  void shouldReturn400_whenCreateRequestInvalid() throws Exception {
    CreateEventRequest request = new CreateEventRequest("", "Desc", null, null, null, null, null);
  ...
  void shouldGetEventById() throws Exception {
    ...
    mockMvc
        .perform(get("/api/v1/events/{id}", eventId))
  ...
  void shouldListEvents() throws Exception {
    Page<EventSummaryResponse> page =
        new PageImpl<>(
            List.of(
  ...
  void shouldListEventsByStatus() throws Exception {
    ...
    mockMvc
        .perform(get("/api/v1/events").param("status", "DRAFT"))
        .andExpect(status().isOk())
  ...
  void shouldUpdateEvent() throws Exception {
    UpdateEventRequest request =
        new UpdateEventRequest("Updated", null, null, null, null, null, null);
    EventResponse response =
        new EventResponse(
            eventId,
            "Updated",
  ...
  void shouldPublishEvent() throws Exception {
    ...
    mockMvc
        .perform(post("/api/v1/events/{id}/publish", eventId).header("X-User-Id", "user-123"))
        .andExpect(status().isOk())
  ...
  void shouldCancelEvent() throws Exception {
    ...
    mockMvc
        .perform(post("/api/v1/events/{id}/cancel", eventId).header("X-User-Id", "user-123"))
        .andExpect(status().isOk())
  ...
  void shouldDeleteEvent() throws Exception {
    mockMvc
        .perform(delete("/api/v1/events/{id}", eventId).header("X-User-Id", "user-123"))
